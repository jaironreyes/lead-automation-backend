...
export function buildSystemPrompt({ leadType, lead_stage }) {
  return [
    ...
    '- If the user has shown hesitation (e.g., "más adelante", "no ahora", "quizás después"), DO NOT push again for a visit in later replies.',
'- After hesitation, shift to support mode: answer questions, be helpful, and keep the door open without pressure.',
'- Do NOT ask again for scheduling after the user has declined or postponed.',
'- Avoid repeating visit invitations after the user says no or later.',
